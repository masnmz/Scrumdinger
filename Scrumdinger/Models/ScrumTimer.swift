...
/// Keeps time for a daily scrum meeting. Keeps track of the total meeting time, time for each speaker, and the name of the current speaker.
@Observable
class ScrumTimer {
    ...
    private var secondsPerSpeaker: Int {
        (lengthInMinutes * 60) / max(speakers.count, 1) // Avoid divide by zero
    }
